    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            if ($rowCount > 0) {
             ...
             // If there are any errors, display them; otherwise, insert the user data into the database
            if (count($errors) > 0) {
                ...
                if ($prepareStmt) {
                    mysqli_stmt_bind_param($stmt, "sssss", $firstName, $lastName, $email, $passwordHash, $address);
